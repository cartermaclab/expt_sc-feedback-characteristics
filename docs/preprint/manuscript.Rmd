...
authornote: |
  ...
  \noindent Data and code: https://github.com/cartermaclab/expt_sc-feedback-characteristics \vspace{2ex} \newline
  \noindent \textbf{Corresponding authors:} Michael J. Carter (michaelcarter@mcmaster.ca) and Laura St. Germain (stgerml@mcmaster.ca).
